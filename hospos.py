...
def apoint():
    global x1
    root2=Tk()
    label=Label(root2,text="APPOINTMENT",font='arial 18 bold')
    label.pack()
...
def lst_doc():
    ...
    l=["Dr. Raghav Kathuria","Dr. Amber Paul","Dr. Harsh Kumar","Dr. Neeraj S Bisht","Dr. V. Kohli","Dr. Piyush","Dr. Sidharth","Dr. tendulkar","Dr. Virat","Dr. Leo",'Dr. Irfan','Dr. John',
       'Dr. Sanjay','Dr. Shahid']
...
def mod_sub():
    global x3,ad
    root7=Tk()
    label=Label(root7,text="MODIFICATION",font='arial 18 bold')
    label.pack()
...
def search_data():
    global x3,ad
    root7=Tk()
    label=Label(root7,text="SEARCH DATA",font='arial 18 bold')
    label.pack()
    frame=Frame(root7,height=200,width=200)
    frame.pack()
    l1=Label(root7,text="AADHAAR NO.")
...
root=Tk()
label=Label(root,text="GNIOT HOSPITAL",font="Times 60 underline bold")
b1=Button(text="Registration",font="arial 20 bold",bg='light blue',command=register)
b2=Button(text="Appointment",font="arial 20 bold",bg='light blue',command=apoint)
b3=Button(text="List of Doctors",font="arial 20 bold",bg='light blue',command=lst_doc)
b4=Button(text="Services available",font='arial 20 bold',bg='light blue',command=ser_avail)
b7=Button(text="View data",font='arial 20 bold',bg='light blue',command=search_data)
b5=Button(text="Modify existing data",font='arial 20 bold',bg='light blue',command=mod_sub)
